 ...
 */
public class SGSCheckBox extends JCheckBox {
    public static final String CLASS = Thread.currentThread().getStackTrace()[1].getClassName();

    public SGSCheckBox(String FROM_CLASS, String FROM_METHOD, int x, int y, int width, int height, String text, Color color) {
        ...
        setSelectedEx(FROM_CLASS, FROM_METHOD, true);
    ...
    public void setSelectedEx(String FROM_CLASS, String FROM_METHOD, boolean isSelected) {
        String METHOD = Thread.currentThread().getStackTrace()[1].getMethodName();
        Log.write(FROM_CLASS, FROM_METHOD, CLASS, METHOD, Log.S);

        Log.write("setSelected(" + isSelected + ");");
