 ...
 */
public class SGSTextLabel extends JLabel {
    public static final String CLASS = Thread.currentThread().getStackTrace()[1].getClassName();

    public SGSTextLabel(String FROM_CLASS, String FROM_METHOD, int x, int y, int width, int height, String text, Color color) {
